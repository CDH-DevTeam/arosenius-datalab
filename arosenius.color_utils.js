...
module.exports = {
	colorObject: function(color) {
		...
		return {
			...
			hex: hex,
			hsv: {
				h: hsv[0] == null || typeof hsv[0] == 'null' ? 0 : Math.round(hsv[0]), 
				s: hsv[1] == null || typeof hsv[0] == 'null' ? 0 : Math.round(hsv[1]*100), 
				v: hsv[2] == null || typeof hsv[0] == 'null' ? 0 : Math.round(hsv[2]*100)
			},
